    ...
    constructor(props){
      ...
      render() {
        ...
        <fieldset id="Register_up" className="ba b--transparent ph0 mh0">
          <legend className="f2 fw6 ph0 mh0 white center">Buy an Item</legend>
          ...
          <div className="mt3">
            ...
            <input className="pa2 FFFF00 input-reset ba bw1 b--white bg-transparent w-30 white" type="number" name="cost"  id="cost" onChange={this.onCostChange}/>
        </div>
        </fieldset>
